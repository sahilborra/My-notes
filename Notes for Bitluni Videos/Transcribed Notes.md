...
40 kHz transmitter
Function:- calculates distance, then pan horizontally or tilt vertically by a small angle
Visualization:- the angle of the transducer and the distance is used to map on 3d plane
Limitation:- Very slow, must wait for the echo to come back. Not practical for real time visualization
